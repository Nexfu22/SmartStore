...
int main() {
    cout << "==============================" << endl;
    cout << "   Smart Store - Student 1    " << endl;
    cout << "==============================" << endl;

    // Create 4 products using base class pointers (polymorphism)
    Product* products[4];
    ...
    // Display all products (calls overridden displayInfo)
    cout << "\n===== All Products =====" << endl;
    for (int i = 0; i < 4; i++) {
    ...
    products[2]->buyMultiple(100); // not enough stock
